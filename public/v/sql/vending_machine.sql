...
) ENGINE=InnoDB AUTO_INCREMENT=327 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='上药记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sub_drug_info` (
  ...
  `machine_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '机器主键',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='下药记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-10-11 17:05:01
