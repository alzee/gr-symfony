...
CREATE TABLE `sales_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=987 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='销售记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-09-27 19:05:01
